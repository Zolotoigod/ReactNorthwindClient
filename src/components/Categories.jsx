    ...
    return(
        <div>
            <Table className='mt-4' striped bordered hover variant='dark' size='lg'>
                ...
                <tbody>
                    {cats.array.map(category=>
                            <tr key={category.categoryId}>
                                <td><h5>{category.categoryId}</h5></td>
                                <td>
                                    <h5>{category.categoryName}</h5>
                                    <p>{category.description}</p>
                                </td>
                                {/* <td><img src={require("../Content/pic.bmp")}
                                width='90px'
                                alt='somthing wrong...' /></td> used static picture here!!*/}
                                {/* <td><img src={`data:image/bmp;base64,${Buffer.from(category.picture).toString('base64')}`}
                                width='90px'
                                alt='somthing wrong...' /></td> */}
                                <td><img src={`data:image/bmp;base64,${pic64}`}
                                width='90px'
                                alt='somthing wrong...' /></td>
                            </tr>
                        )}
